...
class Config:
    def __init__(self, is_context_assert_optional: bool,
                 ...
                 allow_unused_context_attributes: bool):
        ...
        self.allow_unused_context_attributes = allow_unused_context_attributes
...
class DefaultConfig(Config):
    def __init__(self,
                 ...
                 allow_unused_context_attributes: bool = True):
        super().__init__(
            ...
            allow_unused_context_attributes=allow_unused_context_attributes
        )
